...
/*
 Functions:
   CGLM_INLINE void  glm_frustum(float left,    float right,
                                 ...
                                 mat4  dest)
   CGLM_INLINE void  glm_frustum_zo(float left,    float right,
                                    float bottom,  float top,
                                    float nearVal, float farVal,
                                    mat4  dest)
   CGLM_INLINE void  glm_ortho(float left,    float right,
                               ...
                               float nearVal, float farVal,
                               mat4  dest)
   CGLM_INLINE void  glm_ortho_zo(float left,    float right,
                                  float bottom,  float top,
                                  float nearVal, float farVal,
                                  mat4  dest)
   ...
   CGLM_INLINE void  glm_perspective(float fovy,
                                     ...
                                     float farVal,
                                     mat4  dest)
   CGLM_INLINE void  glm_perspective_zo(float fovy,
                                        float aspect,
                                        float nearVal,
                                        float farVal,
                                        mat4  dest)
...
/*!
 * @brief set up perspective peprojection matrix using zero-to-one
 *        clip space
 *
 * @param[in]  left    viewport.left
 * @param[in]  right   viewport.right
...
CGLM_INLINE
void
glm_frustum_zo(float left,    float right,
               float bottom,  float top,
               float nearVal, float farVal,
               mat4  dest) {
  float rl, tb, fn, nv;
...
/*!
 * @brief set up orthographic projection matrix using zero-to-one
 *        clip space
 *
 * @param[in]  left    viewport.left
 * @param[in]  right   viewport.right
...
CGLM_INLINE
void
glm_ortho_zo(float left,    float right,
             float bottom,  float top,
             float nearVal, float farVal,
             mat4  dest) {
  float rl, tb, fn;
...
/*!
 * @brief set up perspective projection matrix using zero-to-one
 *        clip space
 *
 * @param[in]  fovy    field of view angle
 * @param[in]  aspect  aspect ratio ( width / height )
...
#  define glm_frustum_zo           glmc_frustum_zo
#  define glm_ortho                glmc_ortho
#  define glm_ortho_zo             glmc_ortho_zo
...
#  define glm_perspective_zo       glmc_perspective_zo
