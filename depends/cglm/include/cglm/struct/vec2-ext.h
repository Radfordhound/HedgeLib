...
/*
 Functions:
   ...
   CGLM_INLINE HlBool  glms_vec2_eq(vec2s v, float val)
   CGLM_INLINE HlBool  glms_vec2_eq_eps(vec2s v, float val)
   CGLM_INLINE HlBool  glms_vec2_eq_all(vec2s v)
   CGLM_INLINE HlBool  glms_vec2_eqv(vec2s a, vec2s b)
   CGLM_INLINE HlBool  glms_vec2_eqv_eps(vec2s a, vec2s b)
   CGLM_INLINE float glms_vec2_max(vec2s v)
   CGLM_INLINE float glms_vec2_min(vec2s v)
   CGLM_INLINE HlBool  glms_vec2_isnan(vec2s v)
   CGLM_INLINE HlBool  glms_vec2_isinf(vec2s v)
   CGLM_INLINE HlBool  glms_vec2_isvalid(vec2s v)
