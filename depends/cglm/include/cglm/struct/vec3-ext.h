...
/*
 Functions:
   ...
   CGLM_INLINE HlBool  glms_vec3_eq(vec3s v, float val);
   CGLM_INLINE HlBool  glms_vec3_eq_eps(vec3s v, float val);
   CGLM_INLINE HlBool  glms_vec3_eq_all(vec3s v);
   CGLM_INLINE HlBool  glms_vec3_eqv(vec3s a, vec3s b);
   CGLM_INLINE HlBool  glms_vec3_eqv_eps(vec3s a, vec3s b);
   CGLM_INLINE float glms_vec3_max(vec3s v);
   CGLM_INLINE float glms_vec3_min(vec3s v);
   CGLM_INLINE HlBool  glms_vec3_isnan(vec3s v);
   CGLM_INLINE HlBool  glms_vec3_isinf(vec3s v);
   CGLM_INLINE HlBool  glms_vec3_isvalid(vec3s v);
