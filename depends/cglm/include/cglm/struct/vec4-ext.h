...
/*
 Functions:
   ...
   CGLM_INLINE HlBool  glms_vec4_eq(vec4s v, float val);
   CGLM_INLINE HlBool  glms_vec4_eq_eps(vec4s v, float val);
   CGLM_INLINE HlBool  glms_vec4_eq_all(vec4s v);
   CGLM_INLINE HlBool  glms_vec4_eqv(vec4s a, vec4s b);
   CGLM_INLINE HlBool  glms_vec4_eqv_eps(vec4s a, vec4s b);
   CGLM_INLINE float glms_vec4_max(vec4s v);
   CGLM_INLINE float glms_vec4_min(vec4s v);
   CGLM_INLINE HlBool  glms_vec4_isnan(vec4s v);
   CGLM_INLINE HlBool  glms_vec4_isinf(vec4s v);
   CGLM_INLINE HlBool  glms_vec4_isvalid(vec4s v);
