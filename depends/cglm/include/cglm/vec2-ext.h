...
/*
 Functions:
   ...
   CGLM_INLINE HlBool  glm_vec2_eq(vec2 v, float val);
   CGLM_INLINE HlBool  glm_vec2_eq_eps(vec2 v, float val);
   CGLM_INLINE HlBool  glm_vec2_eq_all(vec2 v);
   CGLM_INLINE HlBool  glm_vec2_eqv(vec2 a, vec2 b);
   CGLM_INLINE HlBool  glm_vec2_eqv_eps(vec2 a, vec2 b);
   CGLM_INLINE float glm_vec2_max(vec2 v);
   CGLM_INLINE float glm_vec2_min(vec2 v);
   CGLM_INLINE HlBool  glm_vec2_isnan(vec2 v);
   CGLM_INLINE HlBool  glm_vec2_isinf(vec2 v);
   CGLM_INLINE HlBool  glm_vec2_isvalid(vec2 v);
