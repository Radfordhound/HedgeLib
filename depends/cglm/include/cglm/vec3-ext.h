...
/*
 Functions:
   ...
   CGLM_INLINE HlBool  glm_vec3_eq(vec3 v, float val);
   CGLM_INLINE HlBool  glm_vec3_eq_eps(vec3 v, float val);
   CGLM_INLINE HlBool  glm_vec3_eq_all(vec3 v);
   CGLM_INLINE HlBool  glm_vec3_eqv(vec3 a, vec3 b);
   CGLM_INLINE HlBool  glm_vec3_eqv_eps(vec3 a, vec3 b);
   CGLM_INLINE float glm_vec3_max(vec3 v);
   CGLM_INLINE float glm_vec3_min(vec3 v);
   CGLM_INLINE HlBool  glm_vec3_isnan(vec3 v);
   CGLM_INLINE HlBool  glm_vec3_isinf(vec3 v);
   CGLM_INLINE HlBool  glm_vec3_isvalid(vec3 v);
