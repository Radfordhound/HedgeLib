...
/*
 Functions:
   ...
   CGLM_INLINE HlBool  glm_vec4_eq(vec4 v, float val);
   CGLM_INLINE HlBool  glm_vec4_eq_eps(vec4 v, float val);
   CGLM_INLINE HlBool  glm_vec4_eq_all(vec4 v);
   CGLM_INLINE HlBool  glm_vec4_eqv(vec4 a, vec4 b);
   CGLM_INLINE HlBool  glm_vec4_eqv_eps(vec4 a, vec4 b);
   CGLM_INLINE float glm_vec4_max(vec4 v);
   CGLM_INLINE float glm_vec4_min(vec4 v);
   CGLM_INLINE HlBool  glm_vec4_isnan(vec4 v);
   CGLM_INLINE HlBool  glm_vec4_isinf(vec4 v);
   CGLM_INLINE HlBool  glm_vec4_isvalid(vec4 v);
