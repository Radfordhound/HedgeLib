...
HL_API size_t hlModelFixMatRefs(HlModel** HL_RESTRICT models,
...
HL_API HlResult hlModelWriteMTL(const HlModel** HL_RESTRICT models,
    size_t modelCount, HlFile* HL_RESTRICT file);

HL_API HlResult hlModelExportMTL(const HlModel** HL_RESTRICT models,
