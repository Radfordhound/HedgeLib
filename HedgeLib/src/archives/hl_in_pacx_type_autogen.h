...
HL_IN_PACX_TYPE_AUTOGEN(ResAtmosphericFog)
HL_IN_PACX_TYPE_AUTOGEN(ResDecal)
HL_IN_PACX_TYPE_AUTOGEN(ResDecalPointCloud)
...
HL_IN_PACX_RANGERS_AUTOGEN("lit-anim",             ResAnimLightContainer,        split)
HL_IN_PACX_RANGERS_AUTOGEN("svcol",                ResSvCol,                     root)
HL_IN_PACX_RANGERS_AUTOGEN("model-instanceinfo",   ResModelInstanceInfo,         root)
HL_IN_PACX_RANGERS_AUTOGEN("terrain-instanceinfo", ResMirageTerrainInstanceInfo, root)
HL_IN_PACX_RANGERS_AUTOGEN("atmosphericfog",       ResAtmosphericFog,            root)
HL_IN_PACX_RANGERS_AUTOGEN("bfnt.bin",             ResBitmapFont,                root)
HL_IN_PACX_RANGERS_AUTOGEN("decal",                ResDecal,                     root)
HL_IN_PACX_RANGERS_AUTOGEN("decalpointcloud",      ResDecalPointCloud,           root)
HL_IN_PACX_RANGERS_AUTOGEN("grass.bin",            ResTerrainGrassInfo,          root)
...
HL_IN_PACX_MILLER_AUTOGEN("model-instanceinfo", ResModelInstanceInfo, root)
HL_IN_PACX_MILLER_AUTOGEN("terrain-instanceinfo", ResMirageTerrainInstanceInfo, root)
HL_IN_PACX_MILLER_AUTOGEN("atmosphericfog", ResAtmosphericFog, root)
HL_IN_PACX_MILLER_AUTOGEN("bfnt.bin", ResBitmapFont, root)
HL_IN_PACX_MILLER_AUTOGEN("decal", ResDecal, root)
HL_IN_PACX_MILLER_AUTOGEN("decalpointcloud", ResDecalPointCloud, root)
HL_IN_PACX_MILLER_AUTOGEN("grass.bin", ResTerrainGrassInfo, root)
